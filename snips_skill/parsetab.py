...
_lr_productions = [
  ...
  ('expr -> term','expr',1,'p_expr_term','expr.py',98),
  ('expr -> expr AND expr','expr',3,'p_expr_and','expr.py',102),
  ('expr -> expr OR expr','expr',3,'p_expr_or','expr.py',107),
  ('expr -> NOT expr','expr',2,'p_expr_not','expr.py',112),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_parenthesis','expr.py',117),
  ('term -> TOPIC LESS NUMBER','term',3,'p_term_topic_less_number','expr.py',121),
  ('term -> TOPIC LESS_EQUAL NUMBER','term',3,'p_term_topic_less_equal_number','expr.py',126),
  ('term -> TOPIC GREATER_EQUAL NUMBER','term',3,'p_term_topic_greater_equal_number','expr.py',131),
  ('term -> TOPIC GREATER NUMBER','term',3,'p_term_topic_greater_number','expr.py',136),
  ('term -> TOPIC EQUAL literal','term',3,'p_term_topic_equal_literal','expr.py',141),
  ('term -> TOPIC NOT_EQUAL literal','term',3,'p_term_topic_not_equal_literal','expr.py',147),
  ('term -> TOPIC REGEX_MATCH STRING','term',3,'p_term_topic_regex_match_string','expr.py',153),
  ('literal -> NUMBER','literal',1,'p_literal','expr.py',159),
  ('literal -> STRING','literal',1,'p_literal','expr.py',160),
]
